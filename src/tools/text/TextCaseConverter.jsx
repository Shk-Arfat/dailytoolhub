...
const TextCaseConverter = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Text Case Converter - Uppercase, Lowercase, Title Case | DailyTools
          Hub
        </title>
        <meta
          name="description"
          content="Convert text to uppercase, lowercase, sentence case and title case instantly. Free online text case converter tool."
        />
      </Helmet>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-blue-900/20 rounded-2xl p-8 border shadow-sm">
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-6">
                <button
                  onClick={toUpper}
                  className="bg-green-900 text-white py-3 rounded-lg"
                >
                  UPPERCASE
                </button>
                <button
                ...
                <button
                  onClick={copyText}
                  className="bg-green-600 text-white py-3 rounded-lg flex justify-center gap-2"
                >
                  <Copy size={18} /> Copy
                </button>
                ...
                <button
                  onClick={clearText}
                  className="bg-red-500 text-white py-3 rounded-lg flex justify-center gap-2"
                >
            ...
            <div className="mt-10 space-y-4 text-gray-600 dark:text-gray-300">
              ...
              <p>
                Text case converters help writers, students, and developers
                quickly format text into uppercase, lowercase, title case, or
                sentence case.
              </p>

              <p>
                This tool is useful for content writing, social media, coding,
