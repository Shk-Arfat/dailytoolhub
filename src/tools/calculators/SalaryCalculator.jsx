...
const SalaryCalculator = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Salary Calculator - Calculate Net Salary Online | DailyTools Hub
        </title>
        <meta
          name="description"
          content="Calculate your net salary after deductions and taxes instantly. Free salary calculator for accurate income estimation."
        />
      </Helmet>
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-10 text-gray-600 dark:text-gray-300">
              ...
              <p>
                This tool estimates your take-home salary after PF and income
                tax deductions. Actual salary may vary based on tax slabs and
                company benefits.
              </p>
            </div>
          </div>
