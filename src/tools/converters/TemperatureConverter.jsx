      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-12 bg-white dark:bg-blue-900/20 p-8 rounded-2xl border border-gray-200 dark:border-blue-800/30">
            ...
            {examples.map(v=>(
              <div key={v} className="flex justify-between py-4 border-b dark:border-blue-800/30">
                <span>{v} {from}</span>
                <span>
                  {(()=>{
                    let celsius;
          ...
          <div className="mt-12 space-y-4 text-gray-600 dark:text-gray-300">
            ...
            <p>
              ...
              the United States, and Kelvin is used in scientific calculations.
              This tool helps you quickly convert between all major temperature units.
            </p>

            <p>
              Use this converter to switch between units instantly and understand
              how temperatures compare across different measurement systems.
            </p>
          </div>
