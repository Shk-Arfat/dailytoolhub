...
const ColorConverter = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Color Converter - HEX, RGB, HSL Converter Online | DailyTools Hub
        </title>
        <meta
          name="description"
          content="Convert color formats between HEX, RGB and HSL instantly. Free online color converter tool for designers and developers."
        />
      </Helmet>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-10 bg-white dark:bg-blue-900/20 rounded-2xl p-6 border border-gray-200 dark:border-blue-800/30 shadow-sm">
              ...
              <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                <li>
                  🎨 Click the <strong>color picker box</strong> to open the
                ...
                <li>
                  👀 The preview box shows the selected color in real-time.
                </li>
              </ul>
            </div>
            ...
            <div className="mt-12 space-y-4 text-gray-600 dark:text-gray-300">
              ...
              <p>
                Designers and developers use HEX, RGB, and HSL color formats
                when building websites, apps, and graphics. This tool instantly
