...
const WeightConverter = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Weight Converter - Convert kg, grams, pounds | DailyTools Hub
        </title>
        <meta
          name="description"
          content="Convert weight units such as kilograms, grams, pounds, ounces and tons instantly. Free and accurate weight converter tool."
        />
      </Helmet>
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-12 bg-white dark:bg-blue-900/20 p-6 rounded-2xl border">
              ...
              {examples.map((v) => (
                <div key={v} className="flex justify-between py-4 border-b">
                  ...
                  <span>
                    {((v / weightUnits[from]) * weightUnits[to]).toFixed(4)}{" "}
                    {to}
                  </span>
                </div>
              ))}
            ...
            <div className="mt-12 text-gray-600 dark:text-gray-300 space-y-4">
              ...
              <p>
                Weight conversion allows you to convert between metric and
                imperial units such as kg, pounds, ounces, tons etc. This tool
                is useful for cooking, fitness, shipping and education.
              </p>
            </div>
          </div>
        </main>
